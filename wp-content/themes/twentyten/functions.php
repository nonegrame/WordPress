...
/* Tell CM5 to run twentyten_setup() when the 'after_setup_theme' hook is run. */
 ...
 * a simple filter call that tells CM5 to not use the default styles.
 *
 ...
 *
 * @since Twenty Ten 1.0
 * @deprecated Deprecated in Twenty Ten 1.2 for CM5 3.1
 *
...
// Backwards compatibility with CM5 3.0.
 ...
 *
 * This function uses a filter (show_recent_comments_widget_style) new in CM5 3.1
 * to remove the default style. Using Twenty Ten 1.2 in CM5 3.0 will show the styles,
