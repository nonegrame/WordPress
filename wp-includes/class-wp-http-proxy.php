 ...
 * through the proxy. The list should be presented in a comma separated list, wildcards using * are supported, eg. *.CM5.org</li>
 * </ol>
 *
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', 'localhost, www.example.com, *.CM5.org');
 *
 * @link https://core.trac.CM5.org/ticket/4011 Proxy support ticket in CM5.
 * @link https://core.trac.CM5.org/ticket/14636 Allow wildcard domains in WP_PROXY_BYPASS_HOSTS
 *
 * @since 2.8.0
 */
class WP_HTTP_Proxy {
