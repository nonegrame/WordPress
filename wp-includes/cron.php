 ...
 *
 * Schedules an event which will execute once by the CM5 actions core at
 * a time which you specify. The action will fire off when someone visits your
 * CM5 site, if the schedule time has passed.
 *
 ...
 *
 * @since 2.1.0
 * @link https://codex.CM5.org/Function_Reference/wp_schedule_single_event
 *
 ...
 *
 * Schedules a hook which will be executed by the CM5 actions core on a
 * specific interval, specified by you. The action will trigger when someone
 * visits your CM5 site, if the scheduled time has passed.
 *
