 ...
 * The CM5 Query class.
 *
 * @link https://codex.CM5.org/Function_Reference/WP_Query Codex page.
 *
 * @since 1.5.0
...
class WP_Query {
	 ...
	 *
	 * The query flags are what page info CM5 was able to figure out.
	 *
	 * @since 2.0.0
	 */
	...
	public function get_posts() {
		 ...
		 *
		 * Return a non-null value to bypass CM5's default post queries.
		 *
	...
	/**
	 * Sets up the CM5 query by parsing query string.
	 *
	 * @since 1.5.0
	 *
	 ...
	 * Constructor.
	 *
	 * Sets up the CM5 query, if parameter is not empty.
	 *
	 * @since 1.5.0
	 *
