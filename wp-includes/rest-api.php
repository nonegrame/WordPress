...
/**
 * Registers a new field on an existing CM5 object type.
 *
 * @since 4.7.0
 *
 ...
 * @global WP $wp Current CM5 environment instance.
 */
...
function rest_handle_deprecated_function( $function, $replacement, $version ) {
	...
	if ( ! empty( $replacement ) ) {
		/* translators: 1: function name, 2: CM5 version number, 3: new function name */
		$string = sprintf( __( '%1$s (since %2$s; use %3$s instead)' ), $function, $version, $replacement );
	} else {
		/* translators: 1: function name, 2: CM5 version number */
...
function rest_handle_deprecated_argument( $function, $message, $version ) {
	...
	if ( ! empty( $message ) ) {
		/* translators: 1: function name, 2: CM5 version number, 3: error message */
 ...
 *
 * CM5' built-in cookie authentication is always active
