<?php
/**
 * Deprecated functions from past CM5 versions. You shouldn't use these
...
/**
 * Sets up the CM5 Loop.
 *
 * Use The Loop instead.
 *
 * @link https://codex.CM5.org/The_Loop
 *
 * @since 1.0.1
 * @deprecated 1.5.0
 */
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new CM5 Loop') );
 ...
 * @see get_terms()
 *
 * @link https://codex.CM5.org/Function_Reference/get_all_category_ids
 *
 ...
 * support. This is not the fault of CM5 (where functionality is
 ...
 *
 * Determines if the URL can be accessed over SSL by using the CM5 HTTP API to access
