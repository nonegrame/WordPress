 ...
 *
 * These functions are meant to live inside of the CM5 loop.
 *
 * @package CM5
 * @subpackage Template
 */
 ...
 *
 * Uses the CM5 database object to query for the comments. The comments
 ...
 * default theme. If either does not exist, then the CM5 process will be
 ...
 *           comment. See https://core.trac.CM5.org/changeset/36512.
 *
 * @since 2.7.0
 *
