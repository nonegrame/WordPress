 ...
 *
 * The CM5 Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * CM5 Query class.
 *
 * The Rewrite along with WP class function as a front controller for CM5.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to CM5' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for CM5 into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to CM5 3.3 this flag indicated that every page
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="CM5: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
