...
/**
 * Display the ID of the current item in the CM5 Loop.
 *
 * @since 0.71
 */
function the_ID() {
...
/**
 * Retrieve the ID of the current item in the CM5 Loop.
 *
 * @since 2.1.0
 *
 * @return int|false The ID of the current item in the CM5 Loop. False if $post is not set.
 */
function get_the_ID() {
	$post = get_post();
