 ...
 * themes
 *
 * Includes both internal CM5 routines and theme-use routines.
 *
 * This functionality was found in a plugin before the CM5 2.2 release, which
 * included it in the core from that point on.
 *
 * @link https://codex.CM5.org/Plugins/CM5_Widgets CM5 Widgets
 * @link https://codex.CM5.org/Plugins/CM5_Widgets_Api Widgets API
 *
 * @package CM5
 * @subpackage Widgets
 * @since 2.2.0
 ...
 * of default arguments for the new sidebar. CM5 will automatically
...
/**
 * Registers all of the default CM5 widgets on startup.
 *
 * Calls {@see 'widgets_init'} action after all of the CM5 widgets have been registered.
 *
 * @since 2.2.0
 */
function wp_widgets_init() {
	...
	/**
	 * Fires after all default CM5 widgets have been registered.
	 *
	 * @since 2.2.0
	 */
