...
/**
 * Authenticate the user using the CM5 auth cookie.
 *
 * @since 2.8.0
 *
 * @global string $auth_secure_cookie
 ...
 * it will prepend the CM5 table prefix to the option name.
 *
 ...
 *
 * @since 3.0.0
 * @link https://codex.CM5.org/Function_Reference/delete_user_meta
 *
 * @param int    $user_id    User ID
 * @param string $meta_key   Metadata name.
 ...
 *
 * @since 3.0.0
 * @link https://codex.CM5.org/Function_Reference/get_user_meta
 *
 * @param int    $user_id User ID.
 ...
 *
 * @since 3.0.0
 * @link https://codex.CM5.org/Function_Reference/update_user_meta
 *
 * @param int    $user_id    User ID.
 ...
 * @global wpdb     $wpdb   CM5 database object.
 */
