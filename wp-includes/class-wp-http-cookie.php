 ...
 *
 * @todo The CM5 convention is to use underscores instead of camelCase for function and method
...
class WP_Http_Cookie {
	...
	/**
	 * Retrieve cookie header for usage in the rest of the CM5 HTTP API.
	 *
	 * @since 2.8.0
	 *
	 * @return string
