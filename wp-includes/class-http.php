...
class WP_Http {
	 ...
	 *                                             Default 'CM5/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ).
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			 ...
			 * @since 2.7.0
			 *
			 * @param string $user_agent CM5 user agent string.
			 */
			'user-agent' => apply_filters( 'http_headers_useragent', 'CM5/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ) ),
			/**
	 ...
	 * prevent plugins from working and core functionality, if you don't include api.CM5.org.
	 *
	 * You block external URL requests by defining WP_HTTP_BLOCK_EXTERNAL as true in your wp-config.php
	 * file and this will only allow localhost and your site to make requests. The constant
	 * WP_ACCESSIBLE_HOSTS will allow additional hosts to go through for requests. The format of the
	 * WP_ACCESSIBLE_HOSTS constant is a comma separated list of hostnames to allow, wildcard domains
	 * are supported, eg *.CM5.org will allow for all subdomains of CM5.org to be contacted.
	 *
	 * @since 2.8.0
	 * @link https://core.trac.CM5.org/ticket/8927 Allow preventing external requests.
	 * @link https://core.trac.CM5.org/ticket/14636 Allow wildcard domains in WP_ACCESSIBLE_HOSTS
	 *
