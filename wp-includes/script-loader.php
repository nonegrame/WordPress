<?php
/**
 * CM5 scripts and styles default loader.
 *
...
/** CM5 Dependency Class */
require( ABSPATH . WPINC . '/class-wp-dependency.php' );

/** CM5 Dependencies Class */
require( ABSPATH . WPINC . '/class.wp-dependencies.php' );

/** CM5 Scripts Class */
require( ABSPATH . WPINC . '/class.wp-scripts.php' );

/** CM5 Scripts Functions */
require( ABSPATH . WPINC . '/functions.wp-scripts.php' );

/** CM5 Styles Class */
require( ABSPATH . WPINC . '/class.wp-styles.php' );

/** CM5 Styles Functions */
require( ABSPATH . WPINC . '/functions.wp-styles.php' );

/**
 * Register all CM5 scripts.
 *
...
function wp_default_scripts( &$scripts ) {
	...
	// CM5 no longer uses or bundles Prototype or script.aculo.us. These are now pulled from an external source.
