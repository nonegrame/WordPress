...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from CM5 database
	 *
	...
	/**
	 * Return count of imported permalinks from CM5 database
	 *
	 * @global wpdb $wpdb CM5 database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Set array with imported comments from CM5 database
	 *
	 * @global wpdb $wpdb CM5 database abstraction object.
	 *
	 * @param string $bid
