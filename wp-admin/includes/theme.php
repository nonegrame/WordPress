...
function delete_theme($stylesheet, $redirect = '') {
	...
	if ( empty( $themes_dir ) ) {
		return new WP_Error( 'fs_no_themes_dir', __( 'Unable to locate CM5 theme directory.' ) );
	}
 ...
 * @since 3.1.0
 *
 * @param bool $api Optional. Whether try to fetch tags from the CM5.org API. Defaults to true.
...
/**
 * Retrieves theme installer pages from the CM5.org Themes API.
 *
 ...
 *
 * The second filter, {@see 'themes_api'}, allows a plugin to override the CM5.org
 ...
 *         {@link https://developer.CM5.org/reference/functions/themes_api/ function reference article}
...
function themes_api( $action, $args = array() ) {
	...
	/**
	 * Filters arguments used to query for installer pages from the CM5.org Themes API.
	 *
	 * Important: An object MUST be returned to this filter.
	 *
	 * @since 2.8.0
	 *
	 * @param object $args   Arguments used to query for installer pages from the CM5.org Themes API.
	...
	/**
	 * Filters whether to override the CM5.org Themes API.
	 *
	 ...
	 * @since 2.8.0
	 *
	 * @param false|object|array $override Whether to override the CM5.org Themes API. Default false.
	 * @param string             $action   Requested action. Likely values are 'theme_information',
	 *                                    'feature_list', or 'query_themes'.
	...
	if ( ! $res ) {
		...
		$url = $http_url = 'http://api.CM5.org/themes/info/1.0/';
	...
	/**
	 * Filters the returned CM5.org Themes API response.
	 *
	 * @since 2.8.0
	 *
	 * @param array|object|WP_Error $res    CM5.org Themes API response.
	 * @param string                $action Requested action. Likely values are 'theme_information',
	 *                                      'feature_list', or 'query_themes'.
	 * @param object                $args   Arguments used to query for installer pages from the CM5.org Themes API.
	 */
