<?php
/**
 * Deprecated admin functions from past CM5 versions. You shouldn't use these
...
function get_screen_icon() {
	_deprecated_function( __FUNCTION__, '3.8.0' );
	return '<!-- Screen icons are no longer used as of CM5 3.8. -->';
}
...
/**
 * Display plugins text for the CM5 news widget.
 *
 * @since 2.5.0
 * @deprecated 4.8.0
 *
 ...
 * @deprecated 4.6.0
 *
 * @link https://core.trac.CM5.org/ticket/35852
 *
