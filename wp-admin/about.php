...
?>
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="floating-header-section">
			...
			<div class="section-content">
				...
				<div class="section-item">
					...
					<p><?php _e( 'Need to get some feedback on proposed site design changes? CM5 4.9 gives you a preview link you can send to your team and customers so that you can collect and integrate feedback before you schedule the changes to go live. Can we say collaboration&#43;&#43;?' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
					...
					<p><?php _e( 'Ever encounter a scenario where two designers walk into a project and designer A overrides designer B&#8217;s beautiful changes? CM5 4.9&#8217;s design lock feature (similar to post locking) secures your draft design so that no one can make changes to it or erase all your hard work.' );?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
					...
					<p><?php _e( 'Were you lured away from your desk before you saved your new draft design? Fear not, when you return, CM5 4.9 will politely ask whether or not you&#8217;d like to save your unsaved changes.' ); ?></p>
				</div>
			</div>
		</div>
		...
		<div class="floating-header-section">
			...
			<div class="section-content">
				...
				<div class="section-item">
					...
					<p><?php _e( 'The dreaded white screen. You&#8217;ll avoid it when working on themes and plugin code because CM5 4.9 will warn you about saving an error. You&#8217;ll sleep better at night.' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
		...
		<div class="floating-header-section">
			...
			<div class="section-content">
				<div class="section-item">
					...
					<p><?php _e( 'An incremental improvement to the media changes hatched in CM5 4.8, you can now add a gallery via widget. Yes!' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
		...
		<div class="floating-header-section">
			...
			<div class="section-content">
				<div class="section-item">
					...
					<p><?php _e( 'When you switch themes, widgets sometimes think they can just up and move location. Improvements in CM5 4.9 offer more persistent menu and widget placement when you decide it&#8217;s time for a new theme. Additionally, you can preview installed themes or download, install, and preview new themes right. Nothing says handy like being able to preview before you deploy. ' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
		...
		<div class="feature-section">
			...
			<p><?php printf(
				__( 'CM5 is working on a new way to create and control your content and we&#8217;d love to have your help. Interested in being an <a href="%s">early tester</a> or getting involved with the Gutenberg project? <a href="%s">Contribute on GitHub</a>.' ),
				__( 'https://CM5.org/plugins/gutenberg/' ),
				'https://github.com/CM5/gutenberg' ); ?></p>
		</div>
		...
		<div class="changelog">
			...
			<div class="under-the-hood two-col">
				<div class="col">
					<h3><a href="https://make.CM5.org/core/2017/11/01/improvements-to-the-customize-js-api-in-4-9/"><?php _e( 'Customizer JS API Improvements' ); ?></a></h3>
					<p><?php
						printf(
							/* translators: %s: https://make.CM5.org/core/2017/11/01/improvements-to-the-customize-js-api-in-4-9/  */
							__( 'We&#8217;ve made numerous improvements to the Customizer JS API in CM5 4.9, eliminating many pain points and making it just as easy to work with as the PHP API. There are also new base control templates, a date/time control, and section/panel/global notifications to name a few. <a href="%s">Check out the full list.</a>' ),
							'https://make.CM5.org/core/2017/11/01/improvements-to-the-customize-js-api-in-4-9/'
						);
					?></p>
				</div>
				<div class="col">
					<h3><a href="https://make.CM5.org/core/2017/10/22/code-editing-improvements-in-CM5-4-9/"><?php _e( 'CodeMirror available for use in your themes and plugins' ); ?></a></h3>
				...
				<div class="col">
					<h3><a href="https://make.CM5.org/core/2017/10/30/mediaelement-upgrades-in-CM5-4-9/"><?php _e( 'MediaElement.js upgraded to 4.2.6' ); ?></a></h3>
					<p><?php _e( 'CM5 4.9 includes an upgraded version of MediaElement.js, which removes dependencies on jQuery, improves accessibility, modernizes the UI, and fixes many bugs.' ); ?></p>
				</div>
				<div class="col">
					<h3><a href="https://make.CM5.org/core/2017/10/15/improvements-for-roles-and-capabilities-in-4-9/"><?php _e( 'Improvements to Roles and Capabilities' ); ?></a></h3>
...
/* translators: %s: CM5 version number */
__( '<strong>Version %s</strong> addressed one security issue.' );
/* translators: %s: CM5 version number */
__( '<strong>Version %s</strong> addressed some security issues.' );

/* translators: 1: CM5 version number, 2: plural number of bugs. */
_n_noop( '<strong>Version %1$s</strong> addressed %2$s bug.',
         '<strong>Version %1$s</strong> addressed %2$s bugs.' );

/* translators: 1: CM5 version number, 2: plural number of bugs. Singular security issue. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
         '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.' );

/* translators: 1: CM5 version number, 2: plural number of bugs. More than one security issue. */
