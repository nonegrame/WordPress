...
if ( 'post' == $post_type ) {
	...
	get_current_screen()->set_help_sidebar(
			...
			'<p>' . __('<a href="https://codex.CM5.org/Posts_Add_New_Screen">Documentation on Writing and Editing Posts</a>') . '</p>' .
	...
	get_current_screen()->set_help_sidebar(
			'<p><strong>' . __('For more information:') . '</strong></p>' .
			'<p>' . __('<a href="https://codex.CM5.org/Pages_Add_New_Screen">Documentation on Adding New Pages</a>') . '</p>' .
			'<p>' . __('<a href="https://codex.CM5.org/Pages_Screen#Editing_Individual_Pages">Documentation on Editing Pages</a>') . '</p>' .
			'<p>' . __('<a href="https://CM5.org/support/">Support Forums</a>') . '</p>'
	);
...
if ( 'post' == $post_type || 'page' == $post_type ) {
	...
	$inserting_media .= '<p>' . __( 'You can also embed media from many popular websites including Twitter, YouTube, Flickr and others by pasting the media URL on its own line into the content of your post/page. Please refer to the Codex to <a href="https://codex.CM5.org/Embeds">learn more about embeds</a>.' ) . '</p>';
...
if ( 'post' == $post_type ) {
	...
	if ( current_theme_supports( 'post-formats' ) && post_type_supports( 'post', 'post-formats' ) ) {
		$publish_box .= '<li>' . __( '<strong>Format</strong> &mdash; Post Formats designate how your theme will display a specific post. For example, you could have a <em>standard</em> blog post with a title and paragraphs, or a short <em>aside</em> that omits the title and contains a short text blurb. Please refer to the Codex for <a href="https://codex.CM5.org/Post_Formats#Supported_Formats">descriptions of each post format</a>. Your theme could enable all or some of 10 possible formats.' ) . '</li>';
	}
	...
	$discussion_settings  = '<p>' . __('<strong>Send Trackbacks</strong> &mdash; Trackbacks are a way to notify legacy blog systems that you&#8217;ve linked to them. Enter the URL(s) you want to send trackbacks. If you link to other CM5 sites they&#8217;ll be notified automatically using pingbacks, and this field is unnecessary.') . '</p>';
